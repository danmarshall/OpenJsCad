...
module THREE {
    export var CSG = {
        ...
        fromCSG: function (csg: CSG, defaultColor) {
            ...
            var colorMesh = new Mesh(three_geometry, new MeshFaceMaterial(materials));
            ...
            var phongWireframeMaterial = new MeshPhongMaterial({
                wireframe: true,
                transparent: false,
                color: 0    //'black'
            });
            var wireframe = new Mesh(three_geometry, phongWireframeMaterial);
